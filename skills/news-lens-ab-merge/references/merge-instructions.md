...
6. Output ONLY the merged thesis — starting with `---` (the YAML frontmatter) and ending after the last `## Sources` entry. No preamble, no "here is my merge:", no trailing commentary.
